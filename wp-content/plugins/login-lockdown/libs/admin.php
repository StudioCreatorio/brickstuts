...
class LoginLockdown_Admin extends LoginLockdown
{
    ...
    static function main_page()
    {
        ...
        if ($loginlockdown_licensing->is_active()) {
            ...
            if (self::get_rebranding('support_content') !== false) {
                $tabs[] = array('id' => 'loginlockdown_support', 'icon' => 'loginlockdown-icon loginlockdown-support', 'class' => '', 'label' => __('Support', 'login-lockdown'), 'callback' => array('LoginLockdown_Tab_License', 'support'));
            }
