...
class LoginLockdown_Tab_Design extends LoginLockdown
{
    ...
    static function tab_logo()
    {
        ...
        echo '<tr valign="top">
        <th scope="row"><label for="design_logo_url">Logo URL</label></th>
        <td><input type="text" class="regular-text" id="design_logo_url" name="' . LOGINLOCKDOWN_OPTIONS_KEY . '[design_logo_url]" value="' . $options['design_logo_url'] . '" />';
        echo '</td></tr>';
